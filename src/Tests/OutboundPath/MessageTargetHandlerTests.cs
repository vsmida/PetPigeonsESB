...
namespace Tests.OutboundPath
{
    ...
    public class MessageTargetHandlerTests
    {
        ...
        public void setup()
        {
            ...
            _messageTargetsHandler = new MessageTargetsHandler(_callbackRepositoryMock.Object, _peerManagerMock.Object, _peerConfigurationMock.Object, _reliabilityCoordinatorMock.Object);
