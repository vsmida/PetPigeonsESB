...
//        public EndpointManager(ZmqTransportConfiguration configuration, IZmqSocketManager socketManager, IPeerManager peerManager, ISubscriptionManager subscriptionManager)
//        {
...
//        {
//            var publishingEndpoints = _peerManager.GetSubscriptionsForMessageType(eventType.FullName) ?? Enumerable.Empty<string>();
...
//        {
//            var endpoints = _peerManager.GetSubscriptionsForMessageType(message.MessageType);
...
//        {
//            string endpoint = _peerManager.GetPeerSubscriptionFor(message.MessageType, destinationPeer);
//            var socketInfo = GetOrCreateSocketInfo(endpoint);
//            socketInfo.SendingQueue.Add(message);
//        }
